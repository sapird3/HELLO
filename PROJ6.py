...
with open('error_messages.json', 'w') as json_file:
    json.dump(key_value_store2, json_file, indent=4)

with open('error_messages.json', 'r') as json_file:
    print("\nContents of error_messages.json:")
