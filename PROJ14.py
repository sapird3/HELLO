...
# FINALLLLL
# parsing through log, finding which node malfunctions, going to that file, print errors matched and the corrective action associated :)
# projects 13 w 9 included
